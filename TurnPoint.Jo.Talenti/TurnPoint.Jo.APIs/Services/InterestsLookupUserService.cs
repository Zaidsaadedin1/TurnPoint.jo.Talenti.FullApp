...
namespace TurnPoint.Jo.APIs.Services
{
    public class InterestsLookupUserService : IInterestsLookupUserService
    {
        ...
        public InterestsLookupUserService(ILogger<UserService> logger, UserManager<User> userManager, ApplicationDbContext dbContext)
        {
            _logger = logger;
        ...
        public async Task<bool> AddInterestsToUserAsync(int userId, List<int> newInterests)
        {
        ...
        public async Task<bool> RemoveInterestsFromUserAsync(int userId, List<int> interestIds)
        {
        ...
        public async Task<List<GetInterestDto>> GetUserInterestsAsync(int userId)
        {
